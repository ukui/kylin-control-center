...
private:
    ...
    QStringList         m_szItemlist = {"wallpaper","ukui-screensaver","ukui-menu","ukui-panel","ukui-panel2","mouse","touchpad","keyboard","shortcut","area","datetime","default-open","notice","indicator-china-weather","kylin-video"};
