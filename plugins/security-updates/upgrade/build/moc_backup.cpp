...
QT_MOC_LITERAL(1, 7, 12), // "bakeupFinish"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 14), // "backupProgress"
QT_MOC_LITERAL(4, 36, 10), // "needBacdUp"
QT_MOC_LITERAL(5, 47, 11), // "startBackUp"
QT_MOC_LITERAL(6, 59, 8) // "sendRate"

    },
    "BackUp\0bakeupFinish\0\0backupProgress\0"
    "needBacdUp\0startBackUp\0sendRate"
};
...
void BackUp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->bakeupFinish((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->backupProgress((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: { int _r = _t->needBacdUp();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 3: _t->startBackUp((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->sendRate((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
